...
$french = array(
	 ...
	 */
	'bookmarks' => "Références",
	'bookmarks:add' => "Ajouter un lien",
	'bookmarks:edit' => "Modifier un lien",
	'bookmarks:owner' => "Les liens de %s",
	'bookmarks:friends' => "Les liens de vos relations",
	'bookmarks:everyone' => "Tous les liens",
	'bookmarks:this' => "Mettre cette page en lien",
	'bookmarks:this:group' => "Références rassemblées dans le groupe %s",
	'bookmarks:bookmarklet' => "Installer le script pour les liens",
	'bookmarks:bookmarklet:group' => "Installer le script pour les liens de groupe",
	'bookmarks:inbox' => "Liens et références : boîte de réception",
	'bookmarks:morebookmarks' => "Plus de liens",
	'bookmarks:more' => "Plus",
	'bookmarks:with' => "Partager avec",
	'bookmarks:new' => "Un nouveau lien",
	'bookmarks:address' => "Addresse de la référence",
	'bookmarks:none' => 'Pas (encore) de lien :-(',

	'bookmarks:notification' =>
'Tiens ? %s a ajouté une nouvelle ressource :

%s - %s
%s

A voir et à commenter sur la page de la ressource:
%s
',
